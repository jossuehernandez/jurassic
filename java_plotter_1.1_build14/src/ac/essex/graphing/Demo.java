...
import ac.essex.graphing.view.GraphApplication;
import ac.essex.graphing.charts.continuous.Circle1;
import ac.essex.graphing.charts.continuous.Line;
import ac.essex.graphing.charts.continuous.Polynomial;
import ac.essex.graphing.charts.continuous.SigmoidFunction;
...
//        graph.functions.add(new SineWave());
        graph.functions.add(new Polynomial());
        p.setPlotColor(Color.BLUE);
        
        
//        graph.functions.add( new Line().setFunction( new Function() {
//        	@Override
//			public double get( double x ) { return x*x;}
//		}));
//        graph.functions.add( new Line().setFunction( new Function() {
//        	@Override
//			public double get( double x ) { return x*x*x; }
//		}));
//        
//        graph.functions.add( new Line() );
        
        System.out.println(new Polynomial().getY(-1));
